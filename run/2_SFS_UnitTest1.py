...
feature_set1_path = None 
feature_set2_path = None 
feature_set3_path = None 
feature_set4_path = None 
feature_set5_path = None 
...
experiment_name = 'UnitTest1_sfs'
 

features_set, label_set = load_breast_cancer(return_X_y=True)
